# Object-Field_Detection
Use a depth camera to create an algorithm that would detect objects approaching and would highlight red with distance measurements for objects in the target area. This is also being used on Raspberry PI 5
